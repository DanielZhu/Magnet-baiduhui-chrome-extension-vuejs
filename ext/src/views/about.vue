    ...
    <div class="about-container">
        ...
        <section class="sec-item sec-about-extension">
            ...
            <article>
                ...
                <strong>主要功能</strong><br/><br/>
                <p>- 百度惠首页精选频道商品浏览（包含精选、活动、晒单、经验）</p>
                <p>- 查看精选商品和活动详情以及评论</p>
                <p>- 支持实时推送，以及音效、类型、频率的个性化</p>
                <p>- 永久缓存最新的优惠列表，保障您优惠到底的买买买权利</p>
                <p>- 支持百度VIP跳转，保障返利权利</p>
                <p>- 支持一键清空缓存、还原所有默认配置</p>
                <p>- 支持勿扰模式，关键时段给你一片寂静（静默更新优惠，暂停推送）</p>
                <p>- 支持插件Icon右键一键直达爆料入口、PC站首页，以及手动检查更新</p>
                <p>- 有新优惠时，徽标随机动画提醒，更特别的吸引您的余光</p>
                <p>- 酷炫闪屏动画</p><br/>
